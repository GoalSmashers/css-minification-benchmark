...
const write = (processedFiles, activeMinifiers, asHTML, measureGzip, showTotal, filter) => {
  ...
  const minifierNames = activeMinifiers.slice(0).map(minifier => {
...
exports.getOutput = (asHTML, measureGzip, total) => {
