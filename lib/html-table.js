module.exports = function(options) {
  ...
  var buildPage = function() {
    ...
    page.push('<link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.0.3/css/bootstrap.min.css">');
    page.push('<style>th{text-align:center;vertical-align:middle!important}.text-danger,.text-success,.text-warning{font-weight:700}</style>');
    page.push('</head>');
    page.push('<body>');
