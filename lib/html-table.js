...
<body>
  <div class="container-fluid">
    ...
    <div class="machine-info my-2">
      ...
      <pre class="bg-light text-dark p-3">${machineInfo()}</pre>
    </div>
    <footer class="text-muted my-3">Page generated on <time datetime="${data.date.iso}">${data.date.human}</time></footer>
    </div>
  </body>
</html>`;
