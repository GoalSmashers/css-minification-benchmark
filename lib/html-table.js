...
<body>
  <div class="container-fluid">
    ...
    <div class="machine-info">
      <p class="mb-2">Results were generated on:</p>
      <pre><code>${getMachineInfo()}</code></pre>
    </div>
    <footer class="text-muted pt-2 pb-3">Page generated on <time datetime="${data.date.iso}">${data.date.human}</time></footer>
    </div>
  </body>
</html>`;
